...
a_punk_chroma <- a_punk |>
  ...
  theme_classic() +
  labs(x = "", y = "", title = "Chroma-based Self-Similarity Matrix") + theme(title = element_text(size = 12))
...
a_punk_timbre <- a_punk |>
  ...
  scale_fill_viridis_c(guide = "none") +
  theme_classic() +
  labs(x = "", y = "", title = "Timbre-Based Self-Similarity Matrix") + theme(title = element_text(size = 12))
