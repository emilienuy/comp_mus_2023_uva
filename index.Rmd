...
### Does Indie Pop Live Up To Its Name? {data-commentary-width=400}
``` {r}
pop <- indie %>%
  group_by(category) %>%
...
### Indie Keys
```{r}
key_histogram <- ggplot(indie, aes(x=key, color=category, fill=category)) + geom_histogram(binwidth = 0.5, alpha=0.6) + scale_x_continuous(breaks = c(0:11), labels=c("C","C#","D","D#","E","F","F#","G","G#","A","A#","B")) +
  # facet_wrap(~category) +
