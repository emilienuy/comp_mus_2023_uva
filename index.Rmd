...
### Tempo Variation, Duration, and Volume
``` {r}
volume_tempo <- indie |>
  mutate(
    sections =
...
***
This graph displays information about the overall temporal features of the three playlists. The duration of a song is represented by a point's size, and the volume is represented by transparancy. As discussed before, we can observe that indie folk is the quietest sub-genre with many orange points being more transparent than points from other sub-genres. The song durations vary across each sub-genre in similar ways. Hence, the duration of songs cannot help us distinguish between the three playlists, which can vary between 2mins and 6mins. Most of the songs are clustered at a standard deviation below one.

This graph plots the average tempo of a song in BPM and the standard deviation of the tempo within the song itself. Most of the songs are clustered at a standard deviation below 1, indicating that most indie songs stick to one tempo throughout the entire song. This is not surprising as when you listen to indie songs, the tempo does not typically vary. There are three songs that stand out and have the highest standard deviation in tempo in their respective sub-genre. "Free Flow" by Kamal is an indie pop song with the highest SD of 5, "Paint" by The Paper Kites is an indie folk song with the second highest SD of 4.3, and "The Rover" by Interpol is an indie rock sonf with the third highest SD of 3.8. In the next pages, I will examine the tempo of these three songs more closely.
