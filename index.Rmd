...
<!-- ``` -->
<!-- *** -->
<!-- Based on Spotify features, these are the clusters. -->

<!-- ### Classification -->
<!-- ```{r} -->
<!-- indie <- -->
<!--   bind_rows( -->
<!--     pop |> mutate(playlist = "Indie Pop") |> slice_head(n = 50), -->
<!--     folk |> mutate(playlist = "Indie Folk") |> slice_head(n = 50), -->
<!--     rock |> mutate(playlist = "Indie Rock") |> slice_head(n = 50) -->
<!--   ) |> -->
<!--   add_audio_analysis() -->
