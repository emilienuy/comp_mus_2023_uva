...
energy_valence + scale_color_gradient(low = "yellow", high = "purple") + labs(x = "Energy", y = "Loudness") 
...
#### Chromagram of "j's lullaby" by Delaney Bailey
```{r}
j_lullaby <-
...
#### Chromagram of "Slow Hands" by Interpol
